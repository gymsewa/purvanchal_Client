    ...
    <footer className="bg-white pt-12 pb-6">
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <p className="text-gray-600 mb-4">
                Experience luxury living at its finest with our latest development featuring:
              </p>
            ...
            <div className="text-center md:text-right">
              ...
              <button onClick={() => onEnquire('brochure')} className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
                Download Brochure
              </button>
            </div>
          </div>
        ...
        <div className=" mb-4">
          ...
          <div>
            <h4 className="text-xl flex justify-center items-center font-bold text-gray-800 mb-4">Quick Links</h4>
            <div className="flex justify-center items-center gap-10 text-gray-600">
              <span><a href="#about" className="hover:text-blue-600">Home</a></span>
              <span><a href="#specifications" className="hover:text-blue-600">Specification</a></span>
              <span><a href="#amenities" className="hover:text-blue-600">Amenities</a></span>
              <span><a href="#location" className="hover:text-blue-600">Location</a></span>
            </div>
          </div>
          {/* <div>
        ...
        <div className="border-t border-gray-200 pt-2 text-center text-gray-600">
          ...
          <a href="bytewave.in" target="_blank" className="text-blue-600 hover:underline">Developed with ❤️ by BIL</a>
        </div>
      </div>
    </footer>
  );
